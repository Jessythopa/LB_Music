...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("SlayerX/assets/WELL2.PNG")
    ...
    font = ImageFont.truetype('SlayerX/assets/font.ttf', size=50)
    font2 = ImageFont.truetype('SlayerX/assets/font.ttf', size=90)
...
❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ [๛ɴ ʏ ᴋ ᴀ ᴀ ࿐](https://t.me/Amrira_Assist1)**
▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▰
""",
